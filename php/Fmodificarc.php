...
<html>
    ...
    <div class="row">
            ...
            <tbody>
             <?php foreach ($a_pro as $row): ?>
                <tr>
                    ...
                    <td><a href="php/Fmodificaru.php?id=<?php echo $row['idproducto'];?>"><img src='images/modify.png' alt='cont' class='img-responsive'></a></td>
		...
		<div class="window-container zoomin window-container-visible">
            ...
            <form enctype="multipart/form-data" action="ModificarC.php?id=<?php echo $g_pro['idproducto']?>" method="POST">
            Nombre: <input type="text" name="nom" id="nom" value="<?php echo $g_pro['nombre']?>"><br>
            Marca: <input type="text" name="mar" id="mar" value="<?php echo $g_pro['nombre']?>"><br>
            imagen: <input type="file" name="img" id="img" ><br>
            Existencia: <input type="text" name="exi" id="exi" value="<?php echo $g_pro['existencia']?>"><br>
            Precio Cliente: <input type="text" name="pc" id="pc" value="<?php echo $g_pro['pre_clien']?>"><br>
            Precio Proveedor: <input type="text" name="pp" id="pp" value="<?php echo $g_pro['pre_prove']?>"><br>
            ...
            <button><a href="../catalogo.php">Cancelar</a></button>
            </form>
		</div>
	</div>
    </body>
